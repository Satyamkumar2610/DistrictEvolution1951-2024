...
class BackcastChildResult(BaseModel):
    ...
    feature_importances: dict[str, float] = Field(default_factory=dict, description="Relative importance of each feature")
...
class BackcastResponse(BaseModel):
    ...
    conservation_check: ConservationCheck = Field(..., description="Validation that sum of children approximates parent")
